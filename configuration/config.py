...
class Config:
    ...
    PRODUCTS.SECONDARY.THRESHOLD_INWARD = 1
    PRODUCTS.SECONDARY.THRESHOLD_OUTWARD = 1

    PRODUCTS.TERNARY = ProdInput()
    PRODUCTS.TERNARY.THRESHOLD_INWARD = 4
    PRODUCTS.TERNARY.THRESHOLD_OUTWARD = 3
    PRODUCTS.QUATERNARY = ProdInput()
    PRODUCTS.QUATERNARY.THRESHOLD_INWARD = 4
    PRODUCTS.QUATERNARY.THRESHOLD_OUTWARD = 3
