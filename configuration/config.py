...
class Config:
    ...
    # PROBABILITIES.SECONDARY.p1 = 0.1
    ...
    # PROBABILITIES.SECONDARY.global_B = 0.22
    ...
    # PROBABILITIES.TERNARY.global_B = 1
    ...
    # PROBABILITIES.QUATERNARY.global_B = 1
    ...
    # PROBABILITIES.QUINT.global_B = 1
